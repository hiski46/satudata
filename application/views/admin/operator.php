            ...
            <div id="content">
               ...
               Topbar Navbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <center>
                        <h1 class="h3 mb-4 text-gray-800" style="text-align:center"> SELAMAT DATANG SUPER ADMIN</h1>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Kelik tombol "Keluar" jika anda ingin keluar.</div>
